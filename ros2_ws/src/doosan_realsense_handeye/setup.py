...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "simple_aruco_marker1_tf_publisher = doosan_realsense_handeye.simple_aruco_marker1_tf_publisher:main",
            "simple_aruco_marker2_tf_publisher = doosan_realsense_handeye.simple_aruco_marker2_tf_publisher:main",
            "simple_aruco_marker3_tf_publisher = doosan_realsense_handeye.simple_aruco_marker3_tf_publisher:main",
            ...
            "book_storage_place_sequence = doosan_realsense_handeye.book_storage_place_sequence:main",
            "book_mission_service_server = doosan_realsense_handeye.book_mission_service_server:main",
