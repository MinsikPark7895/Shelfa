...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "aruco_marker2_proto_align = doosan_realsense_handeye.aruco_marker2_proto_align:main",
            ...
            "simple_aruco_marker2_tf_publisher = doosan_realsense_handeye.simple_aruco_marker2_tf_publisher:main",
            ...
            "box_regrip_marker2_place_sequence = doosan_realsense_handeye.box_regrip_marker2_place_sequence:main",
            "box_saved_marker2_pose_place_sequence = doosan_realsense_handeye.box_saved_marker2_pose_place_sequence:main",
            "full_pick_then_marker2_place_sequence = doosan_realsense_handeye.full_pick_then_marker2_place_sequence:main",
            ...
            "marker_forward_target_move = doosan_realsense_handeye.marker_forward_target_move:main",
        ],
    },
)
