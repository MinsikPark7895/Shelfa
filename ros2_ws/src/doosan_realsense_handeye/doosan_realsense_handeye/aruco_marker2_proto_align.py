...
MARKER2_JOINT_POSE_DEG = [9.21, -6.98, 110.85, -87.77, 98.93, 14.04]
...
def _with_marker2_defaults(args):
    ...
    defaults = {
        ...
        "enable_initial_translation_jump": "true",
        "initial_translation_jump_axis_mode": "all",
        "initial_translation_jump_scale": "1.0",
        "initial_translation_jump_max_mm": "120.0",
    }
